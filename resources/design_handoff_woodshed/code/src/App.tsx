...
/**
 * The sidebar is gone: SidebarProvider / SidebarInset / AppSidebar / TopBar are all
 * replaced by AppTopNav + AppBottomTabs, and "/" lands on Home instead of redirecting
 * straight into the scales list.
 *
 * Every practice route is unchanged.
 */
function AppContent() {
  return (
