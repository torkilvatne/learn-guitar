  ...
  return (
    ...
    >
      {grid.map((cell) => {
        ...
        /* The caption is the other language: in Numbers mode show the note name,
           in Notes mode show the degree. Previously the caption was hidden in
           Numbers mode and dropped to opacity-10 in Notes mode, so the two modes
           lost information instead of complementing each other. */
