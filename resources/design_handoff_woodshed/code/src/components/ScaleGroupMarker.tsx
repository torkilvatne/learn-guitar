...
/**
 * Was a muted uppercase label between two hairlines — it read as a divider, not a
 * heading. Now an accent tag with a single trailing rule, so it reads as the start
 * of a section.
 */
