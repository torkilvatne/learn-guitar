...
/**
 * Geometry unchanged. Visual changes only: inlay markers become rounded pills in
 * neutral-200, fret wires drop to neutral-300 so they sit behind the strings, the
 * nut thickens to 7px in neutral-800, and fret numbers go to 14px/700.
 */
