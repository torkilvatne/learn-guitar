...
/**
 * Replaces AppSidebar + TopBar. The sidebar competed with Home for "where do I go";
 * now navigation is a quiet secondary bar and Home does the routing.
 */
const NAV_ITEMS = [
...
/** Mobile: the same four destinations as a bottom tab bar, 52px targets. */
