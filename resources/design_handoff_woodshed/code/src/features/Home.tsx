...
/**
 * The task-first landing page: three goals, not three nav items. Replaces the
 * redirect from "/" straight into /scales.
 */
interface Goal {
  kicker: string
  title: string
...
export interface HomeProps {
  /** Most recently viewed scale, if any — from local storage or your existing state. */
